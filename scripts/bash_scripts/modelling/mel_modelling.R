...
write.table(tot_count_matrix, "../mel_counts.txt")
...
write.table(anova_list, "../mel_anova_list.txt", quote = FALSE)
write.table(lost_genes, "../mel_lost_genes.txt", quote = FALSE)
write.table(mf_contrast, "../mel_mf_contrast.txt", quote = FALSE)
write.table(stage_contrast, "../mel_stage_contrast.txt", quote = FALSE)
write.table(leg_contrast, "../mel_leg_contrast.txt", quote = FALSE)
write.table(mf_separate, "../mel_mf_separate.txt", quote = FALSE)
sessionInfo()
