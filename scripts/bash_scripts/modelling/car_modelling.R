...
#missingGenes <- grep('V',tot_count_matrix)
...
write.table(tot_count_matrix, "../car_counts.txt")
...
count <- 0
anova_list <- matrix(nrow = 11687*7, ncol = 8)
lost_genes <- list()
...
write.table(anova_list, "../car_anova_list.txt", quote = FALSE)
write.table(lost_genes, "../car_lost_genes.txt", quote = FALSE)
write.table(mf_contrast, "../car_mf_contrast.txt", quote = FALSE)
write.table(stage_contrast, "../car_stage_contrast.txt", quote = FALSE)
write.table(leg_contrast, "../car_leg_contrast.txt", quote = FALSE)
write.table(mf_separate, "../car_separate.txt", quote = FALSE)
sessionInfo()
